                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="post" action="{{ isset($post) ? route('posts.update', $post->id) : route('posts.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data"class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="email" name="email" type="email" class="mt-1 block w-full" :value="$post->email ?? old('email')" required autofocus />
                            <x-input-error class="mt-2" :messages="$errors->get('email')" />
                        </div>
                        
                        <div>
                            <x-input-label for="usertype" value="Role" />
                            <x-text-input id="usertype" name="usertype" type="text" class="mt-1 block w-full" :value="$post->usertype ?? old('usertype')" required autofocus />
